...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('monthly_reset_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
    ...
    op.create_table(
        ...
        sa.Column('extracted_data', postgresql.JSON(astext=True), nullable=True),
